...
import { AUTHOR_FULL_NAME, AUTHOR_FIRST_NAME } from '@/constants/appConstants'
...
<template>
  <div id="colorlib-page">
    <SideNavbar :authorName="AUTHOR_FIRST_NAME" />
    <!-- END COLORLIB-ASIDE -->
    <div id="colorlib-main">
      <div
        class="hero-wrap js-fullheight"
        style="background-image: url(./src/assets/images/bg_1.jpg)"
      ...
      >
        ...
        <div class="js-fullheight d-flex justify-content-center align-items-center">
          <div class="col-md-8 text text-center">
            <div
              class="img mb-4"
              style="background-image: url(./src/assets/images/author.jpg)"
            ></div>
            <div class="desc">
            ...
            <div class="col-md-4">
              <div class="blog-entry ftco-animate">
                <a
                  href="#"
                  class="img img-2"
                  style="background-image: url(./src/assets/images/image_1.jpg)"
                ></a>
                <div class="text text-2 pt-2 mt-3">
                  ...
                  <div class="author mb-4 d-flex align-items-center">
                    <a
                      href="#"
                      class="img"
                      style="background-image: url(./src/assets/images/person_2.jpg)"
                    ></a>
                    <div class="ml-3 info">
            ...
            <div class="col-md-4">
              <div class="blog-entry ftco-animate">
                <a
                  href="#"
                  class="img img-2"
                  style="background-image: url(./src/assets/images/image_2.jpg)"
                ></a>
                <div class="text text-2 pt-2 mt-3">
                  ...
                  <div class="author mb-4 d-flex align-items-center">
                    <a
                      href="#"
                      class="img"
                      style="background-image: url(./src/assets/images/person_1.jpg)"
                    ></a>
                    <div class="ml-3 info">
                      <span>Written by</span>
                      <h3><a href="#">Dave Lewis</a>, <span>Nov. 28, 2018</span></h3>
            ...
            <div class="col-md-4">
              <div class="blog-entry ftco-animate">
                <a
                  href="#"
                  class="img img-2"
                  style="background-image: url(./src/assets/images/image_3.jpg)"
                ></a>
                <div class="text text-2 pt-2 mt-3">
                  ...
                  <div class="author mb-4 d-flex align-items-center">
                    <a
                      href="#"
                      class="img"
                      style="background-image: url(./src/assets/images/person_3.jpg)"
                    ></a>
                    <div class="ml-3 info">
                      <span>Written by</span>
                      <h3><a href="#">Dave Lewis</a>, <span>Nov. 28, 2018</span></h3>
            ...
            <div class="col-md-4">
              <div class="blog-entry ftco-animate">
                <a
                  href="#"
                  class="img img-2"
                  style="background-image: url(./src/assets/images/image_4.jpg)"
                ></a>
                <div class="text text-2 pt-2 mt-3">
                  <span class="category mb-3 d-block"><a href="#">Travel</a></span>
            ...
            <div class="col-md-4">
              <div class="blog-entry ftco-animate">
                <a
                  href="#"
                  class="img img-2"
                  style="background-image: url(./src/assets/images/image_5.jpg)"
                ></a>
                <div class="text text-2 pt-2 mt-3">
                  <span class="category mb-3 d-block"><a href="#">Travel</a></span>
            ...
            <div class="col-md-4">
              <div class="blog-entry ftco-animate">
                <a
                  href="#"
                  class="img img-2"
                  style="background-image: url(./src/assets/images/image_6.jpg)"
                ></a>
                <div class="text text-2 pt-2 mt-3">
                  <span class="category mb-3 d-block"><a href="#">Travel</a></span>
            ...
            <div class="col-md-4">
              <div class="blog-entry ftco-animate">
                <a
                  href="#"
                  class="img img-2"
                  style="background-image: url(./src/assets/images/image_7.jpg)"
                ></a>
                <div class="text text-2 pt-2 mt-3">
                  <span class="category mb-3 d-block"><a href="#">Fashion</a></span>
            ...
            <div class="col-md-4">
              <div class="blog-entry ftco-animate">
                <a
                  href="#"
                  class="img img-2"
                  style="background-image: url(./src/assets/images/image_8.jpg)"
                ></a>
                <div class="text text-2 pt-2 mt-3">
                  <span class="category mb-3 d-block"
                    ><a href="#">Photography</a>, <a href="#">Travel</a></span
                  >
            ...
            <div class="col-md-4">
              <div class="blog-entry ftco-animate">
                <a
                  href="#"
                  class="img img-2"
                  style="background-image: url(./src/assets/images/image_9.jpg)"
                ></a>
                <div class="text text-2 pt-2 mt-3">
                  <span class="category mb-3 d-block"><a href="#">Technology</a></span>
            ...
            <div class="col-md-4">
              <div class="blog-entry ftco-animate">
                <a
                  href="#"
                  class="img img-2"
                  style="background-image: url(./src/assets/images/image_10.jpg)"
                ></a>
                <div class="text text-2 pt-2 mt-3">
                  <span class="category mb-3 d-block"><a href="#">Fashion</a></span>
            ...
            <div class="col-md-4">
              <div class="blog-entry ftco-animate">
                <a
                  href="#"
                  class="img img-2"
                  style="background-image: url(./src/assets/images/image_11.jpg)"
                ></a>
                <div class="text text-2 pt-2 mt-3">
                  <span class="category mb-3 d-block"><a href="#">Fashion</a></span>
            ...
            <div class="col-md-4">
              <div class="blog-entry ftco-animate">
                <a
                  href="#"
                  class="img img-2"
                  style="background-image: url(./src/assets/images/image_12.jpg)"
                ></a>
                <div class="text text-2 pt-2 mt-3">
          ...
          <div class="row mb-5">
            <div class="col-md">
              <div class="ftco-footer-widget mb-4 ml-md-4">
                ...
                <ul class="list-unstyled categories">
                  <li>
                    <a href="#">Photography <span>(6)</span></a>
                  </li>
                  <li>
                    <a href="#">Fashion <span>(8)</span></a>
                  </li>
                  <li>
                    <a href="#">Technology <span>(2)</span></a>
                  </li>
                  <li>
            ...
            <div class="col-md">
              <div class="ftco-footer-widget mb-4">
                ...
                <ul class="list-unstyled categories">
                  <li>
                    <a href="#">October 2018 <span>(6)</span></a>
                  </li>
                  <li>
                ...
                <div class="block-23 mb-3">
                  <ul>
                    <li>
                      ...
                      ><span class="text"
                        >203 Fake St. Mountain View, San Francisco, California, USA</span
                      >
                    </li>
                    <li>
                      <a href="#"
